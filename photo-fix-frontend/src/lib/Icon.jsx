...
const P = {
  ...
  // messaging / contact
  whatsapp: "M12 3a9 9 0 0 0-7.7 13.7L3 21l4.5-1.2A9 9 0 1 0 12 3z M8.6 8.4c.9 2.6 3.4 5.1 6 6l1.4-1.4 2.3.8v2.3c-5 .6-9.7-4.1-9.1-9.1h2.3l.8 2.3z",
  telegram: "M21 5 3 12l5.5 1.8L11 20l3-4 4.5 3z M8.5 13.8 18 6",
  messenger: "M12 3C6.5 3 2 7.1 2 12c0 2.7 1.3 5.1 3.4 6.7V22l3.2-1.8c1.1.3 2.2.4 3.4.4 5.5 0 10-4.1 10-9S17.5 3 12 3z M6.5 14l4-4.2 2.3 2 3.7-3.9-4 4.2-2.3-2z",
  wechat: "M9 4C5 4 2 6.7 2 10c0 1.9 1 3.6 2.7 4.8L4 17l2.6-1.1c.5.1 1 .2 1.6.2 M8 8.5h.01 M11.5 8.5h.01 M22 15c0-2.8-2.7-5-6-5s-6 2.2-6 5 2.7 5 6 5c.7 0 1.4-.1 2-.3l1.9.8-.5-1.7C21.1 17.9 22 16.5 22 15z M14.5 14h.01 M17.5 14h.01",
  viber: "M12 3C7.3 3 3.5 6.2 3.5 10.2c0 2.2 1.1 4.1 2.8 5.4l-.3 3.9 3.6-2c.8.2 1.6.3 2.4.3 4.7 0 8.5-3.2 8.5-7.9S16.7 3 12 3z M9 8c2 .3 3.7 2 4 4 M9 11c1.1.2 2 1 2.2 2.1",
  discord: "M7.5 7.5A13 13 0 0 1 16.5 7.5 M7.5 7.5 5.5 16a15 15 0 0 0 4.5 2l1-2 M16.5 7.5 18.5 16a15 15 0 0 1-4.5 2l-1-2 M9.7 13a1 1 0 1 0 .01 0 M14.3 13a1 1 0 1 0 .01 0",
  tiktok: "M9.5 9v7a3 3 0 1 1-3-3 M9.5 4c.6 3.2 2.7 4.8 6 4.8",
  pinterest: "M12 3a9 9 0 1 0 3.5 17.3 M9.5 20.5 12 11s-.6-1-.6-2.2c0-1.7 1-2.8 2.6-2.8s2.6 1.1 2.6 2.8c0 2.1-1.6 4.2-3.7 4.2",
  phone: "M5 3a2 2 0 0 0-2 2c0 9 7 16 16 16a2 2 0 0 0 2-2v-3l-4-1-2 2a12 12 0 0 1-5-5l2-2-1-4z",
