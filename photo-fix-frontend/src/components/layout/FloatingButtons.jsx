      ...
      <AnimatePresence>
        {show && (
          <motion.button
            ...
            className="pfz-safe-bottom fixed left-4 z-40 grid h-11 w-11 place-items-center rounded-tl-full rounded-tr-full rounded-br-full rounded-bl-md bg-secondary text-white shadow-lg transition hover:-translate-y-0.5 sm:left-5"
          >
